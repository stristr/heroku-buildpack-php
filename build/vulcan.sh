...
curl -L https://launchpad.net/libmemcached/1.0/1.0.17/+download/libmemcached-1.0.17.tar.gz -o /tmp/libmemcached-1.0.17.tar.gz
echo "downloading PCRE"
curl -L ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-8.33.tar.gz -o /tmp/pcre-8.33.tar.gz
echo "downloading apr"
curl -L ${APACHE_MIRROR_HOST}/apr/apr-1.4.8.tar.gz -o /tmp/apr-1.4.8.tar.gz
...
curl -L ${APACHE_MIRROR_HOST}/httpd/httpd-2.4.4.tar.gz -o /tmp/httpd-2.4.4.tar.gz
...
tar -C /tmp -xzf /tmp/libmemcached-1.0.17.tar.gz
tar -C /tmp -xzf /tmp/pcre-8.33.tar.gz
tar -C /tmp -xzf /tmp/httpd-2.4.4.tar.gz

tar -C /tmp/httpd-2.4.4/srclib -xzf /tmp/apr-1.4.8.tar.gz
mv /tmp/httpd-2.4.4/srclib/apr-1.4.8 /tmp/httpd-2.4.4/srclib/apr

tar -C /tmp/httpd-2.4.4/srclib -xzf /tmp/apr-util-1.5.2.tar.gz
mv /tmp/httpd-2.4.4/srclib/apr-util-1.5.2 /tmp/httpd-2.4.4/srclib/apr-util
